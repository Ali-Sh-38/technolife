...
const Home = ()=>{
    ...
    <React.Fragment>
        ...
        <Slider className="mainSlider md:m-0 mt-25" slidesPerView={1} spaceBetween={0} pagination={false} navigation={false} loop={true} autoplay={{ delay: 4000 }} speed={1000} FreeMode={false} breakpoints={{1500 : {pagination : true, navigation : true}} }>
            <SwiperSlide>
                <img src="images/big-slider.webp" alt="..." className="md:block! hidden!"/>
                <img src="images/mobile slider.webp" alt="..." className="md:hidden! block!" />
            </SwiperSlide>
            <SwiperSlide>
                <img src="images/big-slider.webp" alt="..." className="md:block! hidden!"/>
                <img src="images/mobile slider.webp" alt="..." className="md:hidden! block!" />
        ...
        <div className="text-center my-15 md:mx-10 mx-4">
            ...
            <section className="flex flex-wrap justify-center items-center gap-10 mt-5 dark:text-gray-300">
                <Link to="/list" className="group w-1/4 md:w-1/6 flex flex-col items-center">
        ...
        <div className="text-center my-15 md:mx-10 mx-4">
            ...
            <section className="flex flex-wrap justify-center items-center gap-10 mt-5 dark:text-gray-300">
                <Link to="/technolife/list" className="group w-1/4 md:w-1/6 flex flex-col items-center">
